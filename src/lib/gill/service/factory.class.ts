...
import StandardGillService              from "lib/gill/service.class";

class StandardGillServiceFactory implements GillServiceFactory
{
  construct(
  ...
  {
    return  new StandardGillService(
...
export default StandardGillServiceFactory;
